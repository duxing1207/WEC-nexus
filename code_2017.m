...
%%处理MRIO数据
%读整体
[Type Sheet Format]=xlsfinfo('WEC nexus data_2017.xlsx');
biao = zeros(1302,1302);
biao = xlsread('WEC nexus data_2017.xlsx','Output_Raw','C4:AXD1305');
biao_Y = zeros(1302,155);
biao_Y = xlsread('WEC nexus data_2017.xlsx','Output_Raw','AXE4:BDC1305');
...
ZCC = zeros(1302,1);
ZZSY = zeros(1302,1);
ZCC = xlsread('WEC nexus data_2017.xlsx','Output_Raw','BDE4:BDE1305');
ZZSY = xlsread('WEC nexus data_2017.xlsx','Output_Raw','BDD4:BDD1305');
...
%%处理碳数据
[Type Sheet Format]=xlsfinfo('Emission_Inventories_for_30_Provinces_2017.xlsx');
carbon_biao = zeros(47,1,30);
for i = 1:30
    carbon_biao(:,:,i) = xlsread('Emission_Inventories_for_30_Provinces_2017.xlsx',Sheet{i+1},'W5:W51');
end
...
%%处理能源数据
[Type Sheet Format]=xlsfinfo('Province_Energy_Inventory_2017.xlsx');
energy_biao = zeros(47,20,30);
for i = 1:30
    energy_biao(:,:,i) = xlsread('Province_Energy_Inventory_2017.xlsx',Sheet{i+1},'B4:U50');
end
...
%%处理水数据
[Type Sheet Format]=xlsfinfo('Water-2017.xlsx');
water_biao = zeros(31,42);
water_biao = xlsread('Water-2017.xlsx',Sheet{2},'B3:AQ33');
...
carbon_use_old = carbon_biao_hang;
energy_use_old = energy_biao_new_hang;
